...
// 日期（yyyymmdd）+ 当天第几次改动。每次改动代码后手动把冒号后的序号 +1；
...
function pageShell(title, inner, autoRefresh) {
  return "<!doctype html><html lang=\"zh-CN\"><head><meta charset=\"utf-8\">" +
    ...
    '<footer style="text-align:center;margin-top:18px;font-size:12px;color:#8A919C;">Powered by <a href="https://github.com/chevy222/workbuddy-cf-checkin" target="_blank" rel="noopener">Github</a><br><span style="color:#A8AEB8;">version ' + escapeHtml(BUILD_VERSION) + '</span></footer>' +
    '</div></body></html>';
}
